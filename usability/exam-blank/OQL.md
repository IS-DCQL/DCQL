# Final Examination — OQL / JPQL (Hibernate)
...
> Closed book; answer in plain text. Write each answer in OQL / JPQL (Hibernate); for query-reading questions explain in English, and for result-prediction questions state the expected returned result.
