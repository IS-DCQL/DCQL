#!/usr/bin/env python3
"""DCM schema (template) structure for the organic-polymer data (Table 2, "DCM structure").
...
COLLECTIONS = [("materials_library.json", "materials_library"), ("processing_logs.json", "processing_logs"), ("pa6t_library.json", "pa6t_library")]
